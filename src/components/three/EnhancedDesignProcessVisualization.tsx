...
const EnhancedDesignProcessVisualization: React.FC<EnhancedDesignProcessVisualizationProps> = ({ 
  ...
  return (
    <>      {/* Environment lights with improved lighting setup */}
      ...
      />
      <pointLight position={[-10, 0, -10]} intensity={0.6} color="#E0DDFF" />
      <pointLight position={[10, 10, 10]} intensity={1.2} color="#8B7DD1" />
      <pointLight position={[0, -10, 0]} intensity={0.4} color="#FFE8D6" />
