 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var wy;function Zj(){return wy||(wy=1,function(t){function i(U,I){var ee=U.length;U.push(I);e:for(;0<ee;){var fe=ee-1>>>1,A=U[fe];if(0<l(A,I))U[fe]=I,U[ee]=A,ee=fe;else break e}}function r(U){return U.length===0?null:U[0]}function s(U){if(U.length===0)return null;var I=U[0],ee=U.pop();if(ee!==I){U[0]=ee;e:for(var fe=0,A=U.length,G=A>>>1;fe<G;){var Z=2*(fe+1)-1,Q=U[Z],ie=Z+1,pe=U[ie];if(0>l(Q,ee))ie<A&&0>l(pe,Q)?(U[fe]=pe,U[ie]=ee,fe=ie):(U[fe]=Q,U[Z]=ee,fe=Z);else if(ie<A&&0>l(pe,ee))U[fe]=pe,U[ie]=ee,fe=ie;else break e}}return I}function l(U,I){var ee=U.sortIndex-I.sortIndex;return ee!==0?ee:U.id-I.id}if(t.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var u=performance;t.unstable_now=function(){return u.now()}}else{var f=Date,g=f.now();t.unstable_now=function(){return f.now()-g}}var m=[],p=[],y=1,b=null,j=3,z=!1,T=!1,O=!1,L=!1,C=typeof setTimeout=="function"?setTimeout:null,V=typeof clearTimeout=="function"?clearTimeout:null,D=typeof setImmediate<"u"?setImmediate:null;function X(U){for(var I=r(p);I!==null;){if(I.callback===null)s(p);else if(I.startTime<=U)s(p),I.sortIndex=I.expirationTime,i(m,I);else break;I=r(p)}}function P(U){if(O=!1,X(U),!T)if(r(m)!==null)T=!0,F||(F=!0,_e());else{var I=r(p);I!==null&&Ye(P,I.startTime-U)}}var F=!1,K=-1,J=5,le=-1;function be(){return L?!0:!(t.unstable_now()-le<J)}function Be(){if(L=!1,F){var U=t.unstable_now();le=U;var I=!0;try{e:{T=!1,O&&(O=!1,V(K),K=-1),z=!0;var ee=j;try{t:{for(X(U),b=r(m);b!==null&&!(b.expirationTime>U&&be());){var fe=b.callback;if(typeof fe=="function"){b.callback=null,j=b.priorityLevel;var A=fe(b.expirationTime<=U);if(U=t.unstable_now(),typeof A=="function"){b.callback=A,X(U),I=!0;break t}b===r(m)&&s(m),X(U)}else s(m);b=r(m)}if(b!==null)I=!0;else{var G=r(p);G!==null&&Ye(P,G.startTime-U),I=!1}}break e}finally{b=null,j=ee,z=!1}I=void 0}}finally{I?_e():F=!1}}}var _e;if(typeof D=="function")_e=function(){D(Be)};else if(typeof MessageChannel<"u"){var zt=new MessageChannel,bt=zt.port2;zt.port1.onmessage=Be,_e=function(){bt.postMessage(null)}}else _e=function(){C(Be,0)};function Ye(U,I){K=C(function(){U(t.unstable_now())},I)}t.unstable_IdlePriority=5,t.unstable_ImmediatePriority=1,t.unstable_LowPriority=4,t.unstable_NormalPriority=3,t.unstable_Profiling=null,t.unstable_UserBlockingPriority=2,t.unstable_cancelCallback=function(U){U.callback=null},t.unstable_forceFrameRate=function(U){0>U||125<U?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):J=0<U?Math.floor(1e3/U):5},t.unstable_getCurrentPriorityLevel=function(){return j},t.unstable_next=function(U){switch(j){case 1:case 2:case 3:var I=3;break;default:I=j}var ee=j;j=I;try{return U()}finally{j=ee}},t.unstable_requestPaint=function(){L=!0},t.unstable_runWithPriority=function(U,I){switch(U){case 1:case 2:case 3:case 4:case 5:break;default:U=3}var ee=j;j=U;try{return I()}finally{j=ee}},t.unstable_scheduleCallback=function(U,I,ee){var fe=t.unstable_now();switch(typeof ee=="object"&&ee!==null?(ee=ee.delay,ee=typeof ee=="number"&&0<ee?fe+ee:fe):ee=fe,U){case 1:var A=-1;break;case 2:A=250;break;case 5:A=1073741823;break;case 4:A=1e4;break;default:A=5e3}return A=ee+A,U={id:y++,callback:I,priorityLevel:U,startTime:ee,expirationTime:A,sortIndex:-1},ee>fe?(U.sortIndex=ee,i(p,U),r(m)===null&&U===r(p)&&(O?(V(K),K=-1):O=!0,Ye(P,ee-fe))):(U.sortIndex=A,i(m,U),T||z||(T=!0,F||(F=!0,_e()))),U},t.unstable_shouldYield=be,t.unstable_wrapCallback=function(U){var I=j;return function(){var ee=j;j=I;try{return U.apply(this,arguments)}finally{j=ee}}}}(rf)),rf}var jy;function Qj(){return jy||(jy=1,af.exports=Zj()),af.exports}var of={exports:{}},gt={};/**
 * @license React
...
LotniskoWiec to część projektu arting – inicjatywy łączącej sztukę i inne dziedziny, co widać także w zastosowanej komunikacji wizualnej i planowanym obiekcie przestrzennym.`,images:[ne("projects/lotniskowiec/cover.jpg"),ne("projects/lotniskowiec/lotniskowiec_1.png"),ne("projects/lotniskowiec/lotniskowiec_2.png"),ne("projects/lotniskowiec/lotniskowiec_3.png"),ne("projects/lotniskowiec/lotniskowiec_4.png"),ne("projects/lotniskowiec/lotniskowiec_5.png"),ne("projects/lotniskowiec/lotniskowiec_6.png"),ne("projects/lotniskowiec/lotniskowiec_7.png"),ne("projects/lotniskowiec/lotniskowiec_8.png"),ne("projects/lotniskowiec/lotniskowiec_9.png"),ne("projects/lotniskowiec/lotniskowiec_10.png"),ne("projects/lotniskowiec/lotniskowiec_11.png"),ne("projects/lotniskowiec/lotniskowiec_12.png")],partners:["Aeroklub Bielsko-Bialski","ZSTiH","Liceum Plastyczne","Szkoła Muzyczna"],technologies:["Edukacja STEAM","Sztuka i Technika","Przestrzeń Wystawiennicza","Komunikacja Wizualna"]},{id:1,title:"BB__Design Lab",slug:"bb-design-lab",shortDesc:"Laboratorium projektowe w Bielsku-Białej",category:"Laboratorium",year:2023,coverImage:ne("projects/bb-design-lab/cover.jpg"),fullDesc:`BB__Design Lab to przestrzeń kreatywna stworzona w celu promowania designu
    ...
    rozwoju i odpowiedzialnego designu.`,images:[ne("projects/bb-design-lab/image1.jpg"),ne("projects/bb-design-lab/image2.jpg"),ne("projects/bb-design-lab/image3.jpg")],partners:["ASP Kraków","Miasto Bielsko-Biała"],technologies:["Design Thinking","UX/UI","Projektowanie Usług"]},{id:2,title:"Projekt Arting",slug:"projekt-arting",shortDesc:"Integracja sztuki i technologii w przestrzeni miejskiej",category:"Projekt Miejski",year:2022,coverImage:ne("projects/projekt-arting/cover.jpg"),fullDesc:`Projekt Arting to inicjatywa łącząca sztukę z nowymi technologiami
    ...
    i społeczną.`,images:[ne("projects/projekt-arting/image1.jpg"),ne("projects/projekt-arting/image2.jpg")],partners:["Galeria Bielska BWA","Fundacja Sztuki Nowoczesnej"],technologies:["Sztuka Cyfrowa","IoT","Augmented Reality"]},{id:3,title:"Pszczela Hala",slug:"pszczela-hala",shortDesc:"Edukacyjny projekt promujący pszczelnictwo miejskie",category:"Edukacja Ekologiczna",year:2021,coverImage:ne("projects/pszczela-hala/cover.jpg"),fullDesc:`Pszczela Hala to innowacyjny projekt edukacyjny mający na celu
    ...
    z zakresu pszczelarstwa i ekologii.`,images:[ne("projects/pszczela-hala/image1.jpg"),ne("projects/pszczela-hala/image2.jpg"),ne("projects/pszczela-hala/image3.jpg")],partners:["Koło Pszczelarzy w Bielsku-Białej","Szkoły podstawowe w regionie"],technologies:["Edukacja Ekologiczna","Projektowanie Zrównoważone","Urban Farming"]},{id:4,title:"Międzynarodowe warsztaty dla dzieci Energia Jutra",slug:"energia-jutra",shortDesc:"Warsztaty dla dzieci o odnawialnych źródłach energii",category:"Edukacja",year:2022,coverImage:ne("projects/energia-jutra/cover.jpg"),fullDesc:`Energia Jutra to międzynarodowy projekt warsztatowy skierowany do dzieci
    ...
    odnawialnej oraz estetyczne aspekty zrównoważonego designu.`,images:[ne("projects/portal-sloneczny/image1.jpg"),ne("projects/portal-sloneczny/image2.jpg"),ne("projects/portal-sloneczny/image3.jpg")],partners:["Miasto Bielsko-Biała","Fundacja Energia dla Sztuki"],technologies:["Energia Słoneczna","Interaktywna Sztuka","Projektowanie Oświetlenia"]},{id:6,title:"D-spot.pl Design Portal",slug:"d-spot-design-portal",shortDesc:"Portal internetowy o designie i zrównoważonym rozwoju",category:"Media Cyfrowe",year:2021,coverImage:ne("projects/d-spot/cover.jpg"),fullDesc:`D-spot.pl to portal internetowy poświęcony designowi, architekturze
    ...
    jednocześnie ideę odpowiedzialnego projektowania i świadomej konsumpcji.`,images:[ne("projects/d-spot/image1.jpg"),ne("projects/d-spot/image2.jpg")],partners:["Stowarzyszenie Projektantów Form Przemysłowych","Wydawnictwo Design"],technologies:["UX/UI","Content Management","Digital Publishing"]},{id:7,title:"Ławeczka Beskidzka",slug:"laweczka-beskidzka",shortDesc:"Projekt mebla miejskiego inspirowany lokalnym dziedzictwem",category:"Wzornictwo",year:2019,coverImage:ne("projects/laweczka-beskidzka/cover.jpg"),fullDesc:`Ławeczka Beskidzka to projekt mebla miejskiego inspirowany lokalnym
    ...
    element małej architektury miejskiej, który podkreśla tożsamość regionu.`,images:[ne("projects/laweczka-beskidzka/image1.jpg"),ne("projects/laweczka-beskidzka/image2.jpg"),ne("projects/laweczka-beskidzka/image3.jpg")],partners:["Miasto Bielsko-Biała","Lokalni rzemieślnicy"],technologies:["Wzornictwo Przemysłowe","Rzemiosło","Projektowanie Mebli"]},{id:8,title:"Design Thinking dla dzieci - gra edukacyjna",slug:"design-thinking-dla-dzieci",shortDesc:"Gra edukacyjna ucząca dzieci metodologii Design Thinking",category:"Edukacja",year:2022,coverImage:ne("projects/design-thinking-dla-dzieci/cover.jpg"),fullDesc:`Design Thinking dla dzieci to innowacyjna gra edukacyjna wprowadzająca
    ...
    rozwijając umiejętności kreatywnego myślenia, empatii oraz współpracy.`,images:[ne("projects/design-thinking-dla-dzieci/image1.jpg"),ne("projects/design-thinking-dla-dzieci/image2.jpg")],partners:["Szkoły podstawowe w regionie","Wydawnictwo Gier Edukacyjnych"],technologies:["Design Thinking","Game Design","Edukacja Kreatywna"]},{id:9,title:"Design Bank - miejsce projektowania, miejsce spotkań",slug:"design-bank",shortDesc:"Przestrzeń coworkingowa i wystawowa dla projektantów i przedsiębiorców",category:"Przestrzeń Kreatywna",year:2023,coverImage:ne("projects/design-bank/cover.jpg"),fullDesc:`Design Bank to projekt, polegający na stworzeniu miejsca dla działań związanych z wzornictwem: wystaw, ekspozycji, szkoleń, warsztatów, doradztwa. Miejsca projektowania i gromadzenia informacji o projektowaniu, miejsce dla kształcenia i rozwoju
...
Zapraszamy do współpracy wszystkich uznających potrzebę kreatywnego myślenia.`,images:[ne("projects/design-bank/image1.jpg"),ne("projects/design-bank/image2.jpg"),ne("projects/design-bank/image3.jpg")],partners:["Lokalny Fundusz Biznesowy","Stowarzyszenie Architektów"],technologies:["Adaptive Reuse","Interior Design","Collaborative Spaces"]},{id:10,title:"Artystyczna Chata na Trzonce - miejsce plenerów, miejsce spotkań",slug:"artystyczna-chata-na-trzonce",shortDesc:"Przestrzeń twórcza w tradycyjnej chacie beskidzkiej",category:"Sztuka i Tradycja",year:2020,coverImage:ne("projects/artystyczna-chata/cover.jpg"),fullDesc:`Artystyczna Chata na Trzonce to unikalne miejsce łączące tradycję
    ...
    lokalną kulturę i rzemiosło.`,images:[ne("projects/artystyczna-chata/image1.jpg"),ne("projects/artystyczna-chata/image2.jpg")],partners:["ASP Katowice","Lokalni artyści i rzemieślnicy"],technologies:["Renowacja Zabytkowych Obiektów","Przestrzeń Wystawiennicza","Edukacja Artystyczna"]},{id:11,title:"Dom pracy twórczej majątek",slug:"dom-pracy-tworczej-majatek",shortDesc:"Przestrzeń twórcza w historycznym majątku ziemskim",category:"Sztuka i Dziedzictwo",year:2021,coverImage:ne("projects/dom-pracy-tworczej/cover.jpg"),fullDesc:`Dom pracy twórczej majątek to projekt adaptacji historycznego
...
`,bw=x(W.create(ze))`  text-decoration: none;
  color: inherit;
